This repository contains the documentation for the SILstat (HTTP REST) API, powered by [Docusaurus](https://docusaurus.io/), a Node.js-based static site generator. 
